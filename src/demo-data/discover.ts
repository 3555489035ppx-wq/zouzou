...
export type Poi = { id: string; name: string; cityId: string; latitude: number; longitude: number; address: string; category: string; image: string; mapProviderId?: string; stay: string; transportation: string; introduction: string }
